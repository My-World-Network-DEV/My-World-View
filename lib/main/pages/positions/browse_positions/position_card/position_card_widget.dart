...
import 'position_card_model.dart';
export 'position_card_model.dart';
...
class PositionCardWidget extends StatefulWidget {
  const PositionCardWidget({super.key});
...
class _PositionCardWidgetState extends State<PositionCardWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PositionCardModel());

    _model.expandableExpandableController =
        ExpandableController(initialExpanded: false);
    _model.argumentContentSimpleExpandableExpandableController =
        ExpandableController(initialExpanded: false);
    _model.evidenceContentSimpleExpandableExpandableController =
        ExpandableController(initialExpanded: false);
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            'Position Overview Content, outlining what iit is this user who made the Motion is trying to discuss and what kind of debate they want to initiate.',
                                            maxLines: 6,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                ...
                                children: [
                                  Expanded(
                                    child: Align(
                                      ...
                                      child: wrapWithModel(
                                        model: _model.positonStanceModel1,
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: PositonStanceWidget(),
                                      ),
                                    ),
                                  ),
                                ],
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ToggleIcon(
                                              onPressed: () async {
                                                safeSetState(() => _model
                                                        .toggleContentionShare =
                                                    !_model
                                                        .toggleContentionShare);
                                              },
                                              value:
                                                  _model.toggleContentionShare,
                                              onIcon: Icon(
                                                Icons.share,
                                                color:
                                                    FlutterFlowTheme.of(context)
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            if (_model
                                                    .toggleContentionFollowing ==
                                                true) {
                                              return FFButtonWidget(
                                                onPressed: () {
                                                  print(
                                                      'FollowingPositionButton pressed ...');
                                                },
                                                text: 'Following',
                                  ...
                                  Expanded(
                                    child: Align(
                                      alignment:
                                          AlignmentDirectional(-0.2, 0.0),
                                      child: wrapWithModel(
                                        model: _model.positonStanceModel2,
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: PositonStanceWidget(),
                                      ),
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: Container(
                                        ...
                                        child: ExpandableNotifier(
                                          controller: _model
                                              .argumentContentSimpleExpandableExpandableController,
                                          child: ExpandablePanel(
                                            header: Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Container(
                                        ...
                                        child: ExpandableNotifier(
                                          controller: _model
                                              .evidenceContentSimpleExpandableExpandableController,
                                          child: ExpandablePanel(
                                            header: Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
