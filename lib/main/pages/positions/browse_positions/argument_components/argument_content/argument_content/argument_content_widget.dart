...
import 'argument_content_model.dart';
export 'argument_content_model.dart';
...
class ArgumentContentWidget extends StatefulWidget {
  const ArgumentContentWidget({super.key});

  @override
  State<ArgumentContentWidget> createState() => _ArgumentContentWidgetState();
}

class _ArgumentContentWidgetState extends State<ArgumentContentWidget> {
  late ArgumentContentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ArgumentContentModel());
                  ...
                  child: ExpandableNotifier(
                    ...
                    child: ExpandablePanel(
                                          ...
                                          children: [
                                            badges.Badge(
                                              ...
                                              child: ToggleIcon(
                                                ...
                                                value: _model.toggleArgumentFav,
                                                onIcon: Icon(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ToggleIcon(
                                              ...
                                              value: _model.toggleArgumentShare,
                                              onIcon: Icon(
                                                Icons.share,
                                                color:
                                                    FlutterFlowTheme.of(context)
                      ...
                      theme: ExpandableThemeData(
                        ...
                        hasIcon: true,
                        iconSize: 32.0,
                        iconPadding: EdgeInsets.fromLTRB(0.0, 0.0, 14.0, 0.0),
                      ),
                    ),
                  ),
                ),
