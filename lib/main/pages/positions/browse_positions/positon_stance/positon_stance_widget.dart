...
import 'positon_stance_model.dart';
export 'positon_stance_model.dart';

class PositonStanceWidget extends StatefulWidget {
  const PositonStanceWidget({super.key});

  @override
  State<PositonStanceWidget> createState() => _PositonStanceWidgetState();
}

class _PositonStanceWidgetState extends State<PositonStanceWidget> {
  late PositonStanceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PositonStanceModel());
