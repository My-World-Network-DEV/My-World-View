...
import 'issue_card_simple_model.dart';
export 'issue_card_simple_model.dart';
...
class IssueCardSimpleWidget extends StatefulWidget {
  const IssueCardSimpleWidget({super.key});

  @override
  State<IssueCardSimpleWidget> createState() => _IssueCardSimpleWidgetState();
}

class _IssueCardSimpleWidgetState extends State<IssueCardSimpleWidget> {
  late IssueCardSimpleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IssueCardSimpleModel());
                              ...
                              children: [
                                Expanded(
                                  child: Container(
                                    width: double.infinity,
                                    child: wrapWithModel(
                                      model: _model.issueImportanceStanceModel,
                                      updateCallback: () => safeSetState(() {}),
                                      child: IssueImportanceStanceWidget(),
                                    ),
                                  ),
                                ),
                              ],
