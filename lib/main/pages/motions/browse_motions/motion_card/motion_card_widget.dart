...
import 'motion_card_model.dart';
export 'motion_card_model.dart';
...
class MotionCardWidget extends StatefulWidget {
  const MotionCardWidget({super.key});

  @override
  State<MotionCardWidget> createState() => _MotionCardWidgetState();
}

class _MotionCardWidgetState extends State<MotionCardWidget> {
  late MotionCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MotionCardModel());
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          'Motion Statement Content, Overview outlining what iit is this user who made the Motion is trying to discuss and what kind of debate they want to initiate.',
                                          maxLines: 6,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                              ...
                              children: [
                                Expanded(
                                  child: Align(
                                    ...
                                    child: wrapWithModel(
                                      model: _model.motionPositionStanceModel1,
                                      updateCallback: () => safeSetState(() {}),
                                      child: MotionPositionStanceWidget(),
                                    ),
                                  ),
                                ),
                              ],
                                            ...
                                            badges.Badge(
                                              ...
                                              child: ToggleIcon(
                                                onPressed: () async {
                                                  safeSetState(() => _model
                                                          .toggleMotionFav =
                                                      !_model.toggleMotionFav);
                                                },
                                                value: _model.toggleMotionFav,
                                                onIcon: Icon(
                                          ...
                                          Padding(
                                            ...
                                            child: ToggleIcon(
                                              onPressed: () async {
                                                safeSetState(() => _model
                                                        .toggleMotionShare =
                                                    !_model.toggleMotionShare);
                                              },
                                              value: _model.toggleMotionShare,
                                              onIcon: Icon(
                                                Icons.share,
                                                color:
                                                    FlutterFlowTheme.of(context)
                                ...
                                Row(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          if (_model.toggleMotionFollowing ==
                                              true) {
                              ...
                              children: [
                                Expanded(
                                  child: Align(
                                    alignment: AlignmentDirectional(0.0, 0.0),
                                    child: wrapWithModel(
                                      model: _model.motionPositionStanceModel2,
                                      updateCallback: () => safeSetState(() {}),
                                      child: MotionPositionStanceWidget(),
                                    ),
                                  ),
